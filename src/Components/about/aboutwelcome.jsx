...
import "../../styles/about/aboutwelcome.css"
...
function Aboutwelcome() {
  return (
    ...
    <div className='welcome_section_main_div'>
        ...
        <div className='welcome_top_divs'>
          <motion.div
            className='about_welcome_text'
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.7, delay: 0.4 }}
          >
            Redefining the art of casting with <span className='about_welcome_span'>INNOVATION</span>, <br/> <span className='about_welcome_span'>CRAFTMANSHIP</span>, and  <span className='about_welcome_span'>UNWAVERING QUALITY</span>.
          </motion.div>
