...
import "../../../styles/about/aboutscroll/builifing.css"
function Builifing() {
    return (
        <>
            <div className='builifing_main_div' >
                ...
                <div className='builifing_bottom_div' >
                    ...
                    <div className='builifing_image_div' >
                        <img className='builifing_image' src='https://plus.unsplash.com/premium_photo-1700604012249-e2f3c5645695?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTN8fGJsYWNrJTIwc2NyZWVufGVufDB8fDB8fHww' />
                    </div>
                </div>
            </div>
        </>
