...
import sideBarIcon from "../assets/navbar/sidebarIcon.png";
        ...
        <>
            ...
            <div className='navbar_main_div'>
                ...
                <div className='left_side_div_nav'>
                    <motion.button style={{backgroundColor: "transparent", border: "none"}} onClick={() => setOpen(!open)} whileTap={{ scale: 0.95 }}>
